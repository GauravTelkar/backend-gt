...
public class DbService {
    ...
    // update query
    public void update( String name,Date dob,int empId) throws SQLException {
        String sql1 = "update emp_info set emp_name=?,dob=? where emp_id=?;";
    ...
    public void delete(int empId) throws SQLException {
        String sql1 = "DELETE FROM emp_info WHERE emp_id = ?;";
        var ps1 = connection.prepareStatement(sql1);
